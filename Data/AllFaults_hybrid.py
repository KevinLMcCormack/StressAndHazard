...
for ii in range(0,len(LD)):
    ...
    if np.max(test_z) < 13383 and np.min(test_z) > 4747:
        GoodFIdx.append(ii)
...
OutputForMATLAB['GoodFIdx']=GoodFIdx
    
    
    # ={FaultXY: test_xy, FaultZ: test_z, KrigXY: KrigXY_return, KrigZ: KrigDep, CFF: coulff}
    
sio.savemat('/Users/kmccormack/CSER Dropbox/Kevin McCormack/Utah/FaultCharacterizationProject/UpdatedHazard/Paper/MATLAB_Input_hybrid_AllFaults.mat',OutputForMATLAB)
